...
/**
 * The persistent class for the s_questions database table.
 * 
 */
@Entity
@Cacheable
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@Table(name="s_questions")
@NamedQuery(name="SQuestion.findAll", query="SELECT s FROM SQuestion s")
public class SQuestion implements Serializable {
	...
	@Column(name="step_question")
	private String stepQuestion;
	...
	public Integer getDataInterId() {
		return this.dataInterId;
	}

	public void setDataInterId(Integer dataInterId) {
	...
	public String getStepQuestion() {
		return this.stepQuestion;
	}

	public void setStepQuestion(String stepQuestion) {
