...
/**
 * The persistent class for the s_category_item_mapping database table.
 * 
 */
@Entity
@Table(name="s_category_item_mapping")
@NamedQuery(name="SCategoryItemMapping.findAll", query="SELECT s FROM SCategoryItemMapping s")
public class SCategoryItemMapping implements Serializable {
