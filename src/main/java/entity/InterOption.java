...
/**
 * The persistent class for the inter_options database table.
 * 
 */
@Entity
@Table(name="inter_options")
@NamedQuery(name="InterOption.findAll", query="SELECT i FROM InterOption i")
public class InterOption implements Serializable {
