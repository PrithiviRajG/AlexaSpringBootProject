...
/**
 * The persistent class for the s_category_item database table.
 * 
 */
@Entity
@Table(name="s_category_item")
@NamedQuery(name="SCategoryItem.findAll", query="SELECT s FROM SCategoryItem s")
