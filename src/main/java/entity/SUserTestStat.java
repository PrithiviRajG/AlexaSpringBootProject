...
/**
 * The persistent class for the s_user_test_stats database table.
 * 
 */
@Entity
@Table(name="s_user_test_stats")
@NamedQuery(name="SUserTestStat.findAll", query="SELECT s FROM SUserTestStat s")
public class SUserTestStat implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SUserTestStatPK id;
	...
	public SUserTestStat() {
	}

	public SUserTestStatPK getId() {
		return this.id;
	}

	public void setId(SUserTestStatPK id) {
		this.id = id;
	}
