...
/**
 * The persistent class for the inter_category_group database table.
 * 
 */
@Entity
@Table(name="inter_category_group")
@NamedQuery(name="InterCategoryGroup.findAll", query="SELECT i FROM InterCategoryGroup i")
public class InterCategoryGroup implements Serializable {
